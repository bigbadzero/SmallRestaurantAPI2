...
namespace SmallRestaurantAPI.Migrations
{
    ...
    [Migration("20210528203136_hopefullyResolvedError")]
    partial class hopefullyResolvedError
    {
            ...
            modelBuilder.Entity("SmallRestaurantAPI.Data.Combo", b =>
                {
                    ...
                    b.HasOne("SmallRestaurantAPI.Data.MenuItem", "SideMenuItem")
                        .WithMany()
                        .HasForeignKey("SideMenuItemID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
